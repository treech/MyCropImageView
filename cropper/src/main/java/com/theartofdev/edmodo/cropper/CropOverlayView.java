...
public class CropOverlayView extends View {
  ...
  /** borderCorner show layout in or out */
  private boolean mBorderCornerDisplayedIn;
  ...
  public void setInitialAttributeValues(CropImageOptions options) {
    ...
    mBorderCornerDisplayedIn = options.borderCornerDisplayedIn;
